...
// add get in and make icon when packed light ballista.
...
void onInit(CBlob@ this)
{
	...
	if (this.exists("frame"))
	{
		...
		// GIANT HACK!!!
		if (packed == "catapult" || packed == "bomber" || packed == "ballista" || packed == "mounted_bow" || packed == "longboat" || packed == "warboat" || packed == "lightballista")	 // HACK:
		{
