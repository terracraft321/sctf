// Added a script in onTick and HitWood script. Need to include Hitters.as. Also need to change 206.
...
void onTick(CSprite@ this)
{
	...
	if (!blob.hasTag(burning_tag)) //give way to burning anim
	{
		...
		else if (action2 && HitWood(blob) || (this.isAnimation("axe") && !this.isAnimationEnded()))
		{
...
void onRender(CSprite@ this)
{
	...
	if (blob.isKeyPressed(key_action1) || this.isAnimation("strike") || this.isAnimation("axe"))
	{
...
bool HitWood(CBlob@ this)
{
	...
	if (b !is null)
	{
		if (b.hasTag("wooden") || b.hasTag("tree"))
			return true;
	}
	return false;
}
