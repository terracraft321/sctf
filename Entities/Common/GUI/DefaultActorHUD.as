...
void onRender(CSprite@ this)
{
  ...
  Vec2f pos = Vec2f(getScreenWidth()/60,getScreenHeight()/16);
	Vec2f pos2 = Vec2f(getScreenWidth()/120,getScreenHeight()/16 + 60);
  
  pos2.y += 30;
  GUI::DrawPane(pos2, Vec2f(pos2.x + 160, pos2.y + 32), SColor(255,75,0,130));
  GUI::DrawText("Press 'B' to join the Discord Server!" , pos2, Vec2f(pos2.x + 160, pos2.y + 20), SColor(255, 230, 0, 255), false, false, false);
