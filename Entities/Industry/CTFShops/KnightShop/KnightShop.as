...
{
	AddIconToken( "$molotov$", "Molotov.png", Vec2f(16,16), 1 );
	...
	{
		ShopItem@ s = addShopItem(this, "Cluster Bomb", "$clusterbomb$", "mat_clusterbomb", "A bomb that explodes into multiples");
