...
// Added New Tech Scrolls to MakeWarTradeMenu. Need to add icon tokens.
...
//	addTradeScrollFromScrollDef(trader, "saw", cost_crappiest, Descriptions::saw);
	...
	addTradeScrollFromScrollDef(trader, "mounted_bow", WARCosts::medium_scroll, "Mounted Bow and Outpost for point holding.");
	addTradeScrollFromScrollDef(trader, "lightballista", WARCosts::medium_scroll, "Cheaper ballista. Can make double ballistas by one factory.");
	...
	addTradeScrollFromScrollDef(trader, "bomber", WARCosts::super_scroll, "Hot Balloon that can carry a siege. Allow you to fight or destroy from air.");
	...
	addTradeScrollFromScrollDef(trader, "dropping", WARCosts::crappy_scroll, "Drop or Shoot by Catapult to use. Be careful to factory position.");
	addTradeEmptyItem(trader);
	addTradeEmptyItem(trader);
	...
	addTradeScrollFromScrollDef(trader, "exchange", WARCosts::super_scroll, "Exchange Hearts to Gold.");
