// Added Mounted bow, Molotov, Bomb satchel and Bomb ball. Need add icon tokens on init.
...
void MakeTradeMenu(CBlob@ trader)
{
	...
	s32 cost_bombball = cfg.read_s32("cost_bombball", 50);
	s32 cost_molotov = cfg.read_s32("cost_molotov", 30);
	s32 cost_bombsatchel = cfg.read_s32("cost_bombsatchel", 50);
	...
	addItemForCoin(trader, "Molotov Cocktail", cost_molotov, true, "$mat_molotov$", "mat_molotov", "Burning bomb for Knight.");
	...
	addItemForCoin(trader, "Bomb Satchel", cost_bombarrows, true, "$bomb_satchel$", "bomb_satchel", "Highly explosive powder filled satchel, sticks to walls!");
	//utility stuff
	...
	addItemForCoin(trader, "Bomb Ball", cost_bombball, true, "$bombball$", "bombball", "Explode when drop or launch by catapult.\nDon't hurt allies, but be careful.");
